...
import "./fonts.css"
import NotificationSidebar from "./notification_sidebar"
    ...
    <section className="bg-white py-16 px-6 md:px-20">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        ...
        <div className="flex flex-col items-center gap-8">
          {/* Main Image */}
          <div className="relative group w-60 h-60 rounded-full overflow-hidden border-4 border-white shadow-lg">
            <StaticImage
          ...
          <div className="flex gap-6">
            <div className="relative group w-24 h-24 rounded-full overflow-hidden border-4 border-white shadow-md">
              <StaticImage
        ...
        <div className="text-justify">
          ...
          <p className="text-green-600 font-semibold mb-4 text-base">
          ...
          <p className="text-gray-700 text-sm mb-6 justified-text">
